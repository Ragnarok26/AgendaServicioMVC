    ...
    $("#calendario").jqxScheduler(
        {
            ...
            views:
            [
                { type: 'dayView', workTime: { fromDayOfWeek: 1, toDayOfWeek: 5, fromHour: 8, toHour: 18 }, timeRuler: { timeZones: [{ id: "Central Standard Time (Mexico)", text: "" }] } },
                { type: 'weekView', workTime: { fromDayOfWeek: 1, toDayOfWeek: 5, fromHour: 8, toHour: 18 }, timeRuler: { timeZones: [{ id: "Central Standard Time (Mexico)", text: "" }] } },
                { type: 'monthView', workTime: { fromDayOfWeek: 1, toDayOfWeek: 5, fromHour: 8, toHour: 18 }, timeRuler: { timeZones: [{ id: "Central Standard Time (Mexico)", text: "" }] } },
                { type: 'agendaView', workTime: { fromDayOfWeek: 1, toDayOfWeek: 5, fromHour: 8, toHour: 18 }, timeRuler: { timeZones: [{ id: "Central Standard Time (Mexico)", text: "" }] } }
            ],
            localization: {
